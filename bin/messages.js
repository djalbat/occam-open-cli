...
const PASSWORDS_DO_NOT_MATCH_MESSAGE = "The passwords do not match.",
      ...
      SERVER_FAILED_TO_RESPOND_ERROR_MESSAGE = "The server failed to respond in a timely fashion. If this problem persists, please be kind enough to report it.",
      ...
      RESET_PASSWORD_MESSAGE = "If the username corresponds to an account then an email will have been sent.",
      ...
      INVALID_EMAIL_ADDRESS_OR_USERNAME_MESSAGE = "The email address or usernmae does not appear to be a valid one.",
