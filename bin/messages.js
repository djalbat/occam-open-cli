...
const SERVER_FAILED_TO_RESPOND_ERROR_MESSAGE = 'The server failed to respond in a timely fashion. If this problem persists, please be kind enough to report it.',
      ...
      FAILED_PUBLISH_NO_CONFIGURATION_FILE_MESSAGE = 'Failed to publish the package because there is no configuration file in the directory above.',
...
module.exports = {
  ...
  FAILED_PUBLISH_NO_CONFIGURATION_FILE_MESSAGE,
